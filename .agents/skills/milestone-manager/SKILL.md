...
This skill helps you create and manage project milestones by analyzing the existing codebase, `README.md`, `WIKI.md`, and `AGENTS.md`.

## Workflow

1. **Information Gathering**: Read the root `README.md`, `WIKI.md`, and `AGENTS.md` to understand the project goals and core requirements.
...
6. **Persistence**: Save approved milestones to `.agents/taskboard/milestones.md`.
